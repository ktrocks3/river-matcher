...
def shortest_path_target() -> JunctionGraph:
    return make_graph("target", {10: (0.0, 0.0), 20: (1.0, 0.0), 30: (0.0, 2.0), 40: (2.0, 0.0), },
        (make_edge(0, 10, 20, [(0.0, 0.0), (1.0, 0.0)], ), make_edge(1, 20, 40, [(1.0, 0.0), (2.0, 0.0)], ), make_edge(2, 10, 30, [(0.0, 0.0), (0.0, 2.0)], ),
...
def arch_target() -> JunctionGraph:
    return make_graph("target", {10: (0.0, 0.0), 20: (1.0, 2.0), 30: (3.0, 2.0), 40: (4.0, 0.0), },
        (make_edge(0, 10, 40, [(0.0, 0.0), (4.0, 0.0)], ), make_edge(1, 10, 20, [(0.0, 0.0), (1.0, 2.0)], ), make_edge(2, 20, 30, [(1.0, 2.0), (3.0, 2.0)], ),
         make_edge(3, 30, 40, [(3.0, 2.0), (4.0, 0.0)], ),), )


def parallel_source_graph() -> JunctionGraph:
    return make_graph("source", {1: (0.0, 0.0), 2: (4.0, 0.0), },
        (make_edge(0, 1, 2, [(0.0, 0.0), (2.0, 2.0), (4.0, 0.0), ], ), make_edge(1, 1, 2, [(0.0, 0.0), (2.0, -2.0), (4.0, 0.0), ], ),), )


def parallel_route_target() -> JunctionGraph:
    return make_graph("target", {10: (0.0, 0.0), 20: (2.0, 2.0), 30: (2.0, -2.0), 40: (4.0, 0.0), },
        (make_edge(0, 10, 20, [(0.0, 0.0), (2.0, 2.0)], ), make_edge(1, 20, 40, [(2.0, 2.0), (4.0, 0.0)], ), make_edge(2, 10, 30, [(0.0, 0.0), (2.0, -2.0)], ),
...
def test_shortest_path_parallel_edges_keep_selected_geometry() -> None:
    target = make_graph("parallel", {10: (0.0, 0.0), 20: (2.0, 0.0), },
        (make_edge(0, 10, 20, [(0.0, 0.0), (1.0, 1.0), (2.0, 0.0), ], ), make_edge(1, 10, 20, [(0.0, 0.0), (2.0, 0.0)], ),), )
...
def test_equal_length_parallel_edges_use_first_stored_edge() -> None:
    target = make_graph("parallel-tie", {10: (0.0, 0.0), 20: (2.0, 0.0), },
        (make_edge(0, 10, 20, [(0.0, 0.0), (1.0, 1.0), (2.0, 0.0), ], ), make_edge(1, 10, 20, [(0.0, 0.0), (1.0, -1.0), (2.0, 0.0), ], ),), )
    finder = ShortestPathWitnessFinder(target)
...
def test_path_concatenation_removes_repeated_junction_point() -> None:
    target = make_graph("detailed", {10: (0.0, 0.0), 20: (1.0, 0.0), 30: (2.0, 0.0), },
...
def test_shortest_path_handles_same_invalid_and_disconnected_vertices() -> None:
    target = make_graph("disconnected", {10: (0.0, 0.0), 20: (1.0, 0.0), 30: (10.0, 0.0), 40: (11.0, 0.0), },
